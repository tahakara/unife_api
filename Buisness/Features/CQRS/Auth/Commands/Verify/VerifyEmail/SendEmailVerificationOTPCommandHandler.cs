            ...
            try
            {
                ...
                IBuisnessLogicResult buisnessResult = await BuisnessLogic.Run(
                    new Func<StepContext, Task<IBuisnessLogicResult>>[]
                    {
                        ...
                        ctx => _authBusinessLogicHelper.MapToDtoAsync(request, verifyEmailGetRequestDto),
                        ctx => _authBusinessLogicHelper.IsAccessTokenValidAsync(verifyEmailGetRequestDto.AccessToken),
                        ctx => _authBusinessLogicHelper.CheckIsEmailNotVerifiedAsync(verifyEmailGetRequestDto.AccessToken),
                        
                        // Executors
                        ctx => _authBusinessLogicHelper.SendEmailVerificationOTPAsync(verifyEmailGetRequestDto.AccessToken)
                    });
                ...
                if (buisnessResult != null)
                {
                    await _authBusinessLogicHelper.AddSecurityEventRecordAsync(
                        ...
                        eventTypeGuidKey: SecurityEventTypeGuid.VerificationOTPEmailFailed,
                ...
                await _authBusinessLogicHelper.AddSecurityEventRecordAsync(
                    httpContext: httpContext,
                    eventTypeGuidKey: SecurityEventTypeGuid.VerificationOTPEmailSucceeded,
