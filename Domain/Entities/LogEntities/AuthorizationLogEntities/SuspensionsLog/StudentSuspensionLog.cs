...
namespace Domain.Entities.LogEntities.AuthorizationLogEntities.SuspensionsLog
{
    public class StudentSuspensionLog : LogBaseEntity
    {
        ...
        public Guid? SuspendedByStudentUuid { get; set; }
